...
// Remarks
//		Once this callback returns, the socket and all of its connections
//		 are invalid and can no longer be used.
//		All connections that use this socket are terminated, and their
//		 gt2CloseCallback callbacks will be called 
//		before this callback is called (with the reason set to GT2SocketError).<p>
// See Also
//		gt2CreateSocket
...
//		 of delivery,
// and it needs to hold any messages that arrive out of order. if either
//		 buffer runs out
