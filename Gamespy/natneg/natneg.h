...
// developed by GameSpy Industries. Copyright (c) 2002-2009 GameSpy
//		 Industries, Inc.
//-------------------------------------
...
//		 Negotiation server acknowledges your 
//		connection request (ns_initack), and when the guessed port data has
//		 been received from the NAT Negotiation 
//		server and direct negotiation with the other client is in progress
//		 (ns_connectping).<p>
// See Also
//		NNBeginNegotiation
...
//		gamesocket	: [in] The socket you should use to continue
//		 communications with the client.
//		remoteaddr	: [in] The remote address and port you should use to
//		 communicate with the new client.
//		userdata	: [in] Data for your own use.
// Remarks
//		Once your completed function is called, you can begin sending data
//		 to the other client immediately 
//		using the socket and address provided.<p>
...
//		If you used NNBeginNegotiationWithSocket then the socket parameter
//		 will be the socket you 
//		passed in originally. Otherwise it will be a new socket allocated by
//		 the NAT Negotiation SDK.<p>
...
//		nat		: [in] When detection is successful, this contains the
//		 NAT device's properties.
// Remarks
...
//		 should be retried.
//		If it is gsi_true, then the nat parameter will contain the
//		 properties of the detected NAT device.<p>
// See Also
...
// Remarks
//		Incoming traffic is not processed automatically - you will need to
//		 read the data off 
//		the socket and pass NN packets to NNProcessData.<p>
// See Also
//		NNBeginNegotiation
...
// Summary
//		Internal function that starts the negotiation process using the
//		 socket provided, 
//      which will be shared with the game. Use INVALID_SOCKET const to
//		 signify that the
//      SDK should create a new socket to use for the negotiation.
// Parameters
//		gamesocket			: [in] The socket to be used to start the negotiation
//		cookie				: [in] Shared cookie value that both players will use so that the 
//								NAT Negotiation Server can match them up.
...
// Remarks
//		After you've begun a negotiation and/or NAT detection, you need to
//		 call the NNThink 
//		function on regular intervals (recommended: 100ms) to process the
//		 connection.
//		You may call NNThink when no negotiations are in progress as well -
//		 it will simply return immediately.<p>
void NNThink();
...
//		 incoming data and pass NN packets to 
//		NNProcessData.<p>
// See Also
//		NNBeginNegotiationWithSocket
void NNProcessData(
...
//		 freed using NNFreeNegotiatorList.
//		If any negotiations are outstanding this will cancel them. Calling
//		 this will NOT close the game sockets, 
//		you are free to continue game communications.
...
// Parameters
//		resultscallback	: [in] Callback function that will be called when
//		 NAT detection is complete.
// Returns
//		ne_noerror if successful; otherwise one of the ne_ error values. See
//		 Remarks for detail.
// Remarks
