...
#elif defined(_NITRO) || defined(_REVOLUTION) || defined(_PSP)
#define PEERCBType int
#else
#define PEERCBType intptr_t         // Note: ANSI function pointers should int rather than void*
#endif
