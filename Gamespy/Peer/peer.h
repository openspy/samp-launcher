...
//			<emit \</dt\>>
//				<emit \<dd\>>
//			The client was unsecurely connected to the Chat server and 
...
//			<emit \</dt\>>
//				<emit \<dd\>>
//			The client had his operator priveliges reset, and was kicked out of 
...
//			<emit \</dt\>>
//				<emit \<dd\>>
//			The client had his operator priveliges revoked, and was kicked out 
...
//		<p>
//		Peer stores this ping time idependently and makes the average
...
//      more information.
//      Note: when automatching the NN cookie should be shared via UTM messages 
...
//		automatically for new game titles. To have GameSpy set up one or 
//		more Group ids and associated Chat channels for your game title, 
//		please contact devsupport@gamespy.com. 
// See Also
...
//		<p>
//		If you are using a custom namespace, specify its namespace ID. Contact
//		GameSpy Developer Support at devsupport@gamespy.com for assistance with 
//		custom namespaces.
//		<p>
...
//		that used in server browing and reporting. This should be called after 
...
//		Chat channels are not created automatically for new game titles. To have 
//		GameSpy set up one or more Group ids and associated Chat channels for 
//		your game title, please contact devsupport@gamespy.com. 
//		<p>
//		A list of available Chat channel group ids for your title may be 
//		obtained by calling peerListGroupRooms(). Group ids and their associated
//		Chat channels are not created automatically for new game titles. To have 
