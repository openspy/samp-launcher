...
typedef void (*GSBDisbandBrigadeCallback)(GSResult operationResult, GSResultSet *resultSet, void *userData);
...
//		userData		: [in] Data that was passed in to the function call and 
//								returned to the callback 
typedef void (*GSBGetBrigadeByIdCallback)(GSResult operationResult, GSResultSet *resultSet, 
										  GSBBrigade *theBrigade, void *userData);
...
//		userData		: [in] Data that was passed in to the function call and
//								returned to the callback 
typedef void (*GSBGetBrigadesByProfileIdCallback)(GSResult operationResult, GSResultSet *resultSet, 
												  GSBBrigadeList *brigadeList, void *userData);
...
//		userData		: [in] Data that was passed in to the function call and
//								returned to the callback 
typedef void (*GSBSaveBrigadeCallback)(GSResult operationResult, GSResultSet *resultSet, 
									   GSBBrigade *updatedBrigade, void *userData);
...
//		userData		: [in] Data that was passed in to the function call and
//		returned to the callback 
typedef void (*GSBSearchBrigadesCallback)(GSResult operationResult, GSResultSet *resultSet, 
										  GSBBrigadeList *brigadeList, void *userData);
...
typedef void (*GSBSearchPlayersCallback)(GSResult operationResult, GSResultSet *resultSet, 
...
//		userData		: [in] Data that was passed in to the function call
//								and returned to the callback 
typedef void (*GSBSendMessageToBrigadeCallback)(GSResult operationResult, GSResultSet *resultSet, void *userData);
...
//		userData		: [in] Data that was passed in to the function call
//								and returned to the callback 
typedef void (*GSBSendMessageToMemberCallback)(GSResult operationResult, GSResultSet *resultSet, void *userData);
...
//		userData		: [in] Data that was passed in to the function call and
//								returned to the callback 
typedef void (*GSBUploadLogoCompleteCallback)(GSResult operationResult, GSResultSet *resultSet, void *userData);
...
//		userData		: [in] Data that was passed in to the function call and
//								returned to the callback 
typedef void (*GSBDownloadLogoCompleteCallback)(GSResult operationResult, GSResultSet *resultSet, void *userData);
...
typedef void (*GSBGetBrigadeMemberListCallback)(GSResult operationResult, GSResultSet *resultSet, 
												GSBBrigadeMemberList *brigadeMemberList, void *userData);
...
//		userData		: [in] Data that was passed in to the function call and
//								returned to the callback 
typedef void (*GSBUpdateBrigadeMemberCallback)(GSResult operationResult, GSResultSet *resultSet, void *userData);
...
//		userData		: [in] Data that was passed in to the function call 
//								and returned to the callback 
typedef void (*GSBRemoveBrigadeMemberCallback)(GSResult operationResult, GSResultSet *resultSet, void *userData);
...
//		userData		: [in] Data that was passed in to the function call 
//								and returned to the callback 
typedef void (*GSBPerformBrigadeMemberActionCallback)(GSResult operationResult, GSResultSet *resultSet,
													  void *userData);
...
//		userData		: [in] Data that was passed in to the function call 
//								and returned to the callback 
typedef void (*GSBRemoveRoleCallback)(GSResult operationResult, GSResultSet *resultSet, void *userData);
...
//		userData		: [in] Data that was passed in to the function call 
//								and returned to the callback 
typedef void (*GSBGetRoleListCallback)(GSResult operationResult, GSResultSet *resultSet, 
									   GSBRoleList *roleList, void *userData);
...
//		userData		: [in] Data that was passed in to the function call and 
//								returned to the callback 
typedef void (*GSBUpdateRoleCallback)(GSResult operationResult, GSResultSet *resultSet, 
									  gsi_u32 roleId, void *userData);
