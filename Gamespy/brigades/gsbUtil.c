...
GHTTPBool gsbiUploadCompletedCallback(GHTTPRequest httpRequest, GHTTPResult httpResult, char * httpBuffer, GHTTPByteCount httpBufferLen, void * param)
{
...
GHTTPBool gsbiDownloadCompletedCallback(GHTTPRequest httpRequest, GHTTPResult httpResult, char * httpBuffer, GHTTPByteCount httpBufferLen, void * param)
{
	GSResult result = GS_SUCCESS;
