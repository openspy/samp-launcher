...
static gsi_bool sampleAuthPlayer()
{
	int result = wsLoginUnique(SAMPLE_PARTERCODE, SAMPLE_NAMESPACEID, LOCAL_PLAYER_UNIQUENICK, LOCAL_PLAYER_PASSWORD, "", sampleAuthCallback, NULL);
...
{
    gsi_u32 j=0;
    wprintf(L"\n======================BEGIN ITEM ACTIVATION DATA RESPONSE ======================\r\n", j);
